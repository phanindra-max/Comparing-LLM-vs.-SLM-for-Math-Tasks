...
MODEL_DIR = Path(os.environ.get("LMVSSLM_MODEL_DIR", REPO_ROOT / "outputs" / "models")) / "xgboost"
MODEL_PATH = os.path.join(MODEL_DIR, 'xgb_model.pkl')

# 1. Load data
def load_data(train_path=DATA_DIR / "train.csv", test_path=DATA_DIR / "test.csv"):
