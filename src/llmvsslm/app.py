...
# Defaults to the repository's outputs/models directory. Override with
# LMVSSLM_MODEL_DIR when using an external model artifact location.
REPO_ROOT = Path(__file__).resolve().parents[2]
MODEL_BASE_DIR = os.environ.get("LMVSSLM_MODEL_DIR", str(REPO_ROOT / "outputs" / "models"))
